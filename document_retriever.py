...
class DocumentRetriever:
    ...
    def retrieve(self, query: str, k: int = 5, score_threshold: float = 0.35) -> List[Dict[str, Any]]:
        """
        ...
        """
        logger.info(f"Retrieving documents for query: {query} (k={k}, threshold={score_threshold})")
