...
class ResponseGenerator:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.prompt = ChatPromptTemplate.from_template("""
            ...
            5. في الملفات الموجودة، قد تجد صيغ LaTeX للمعادلات الرياضية. لا تستخدم صيغ LaTeX في إجابتك، بل قم بتحويلها إلى نص عربي عادي.
            ...
            6. التنسيق: لا تستخدم علامات النجمية (*) أو رموز LaTeX في إجاباتك. قدم النص بشكل طبيعي وواضح.
            ...
            تعليمات خاصة:
            - إذا كان نوع الاستفسار هو "تحية"، قم بالرد بتحية مناسبة وأخبر المستخدم أنك مساعد متخصص في الرياضيات يمكنه حل جميع أنواع المسائل الرياضية مثل الجبر والهندسة والتفاضل والتكامل والإحصاء ونظرية الأعداد والمسائل التطبيقية.
            - إذا كان السؤال يتعلق بقدراتك، أخبر المستخدم أنك مصمم لحل جميع أنواع المسائل الرياضية وشرح المفاهيم الرياضية بطريقة واضحة ومفهومة.
    ...
    def generate(self, query: str, context: str, conversation_history: Optional[List[str]] = None, 
        ...
        try:
            ...
            system_instructions = """
            أنت مساعد ذكي متخصص في الرياضيات، مهمتك تقديم إجابات دقيقة ومفصلة عن المسائل الرياضية، معتمداً فقط على المعلومات المقدمة في السياق. يجب عليك شرح المفاهيم الرياضية بطريقة واضحة ومفهومة، وتوضيح خطوات الحل بشكل منطقي ومتسلسل. يجب عليك التفكير والإجابة باللغة العربية فقط، ولا تستخدم اللغة الإنجليزية مطلقاً في إجاباتك. لا تستخدم علامات النجمية (*) أو رموز LaTeX في إجاباتك، بل قدم النص بشكل طبيعي وواضح.
            """
            ...
            هام: لا تستخدم علامات النجمية (*) أو رموز LaTeX في إجابتك، بل قدم النص بشكل طبيعي وواضح.
            """
