...
class QueryAnalyzer:
    def __init__(self, config: Dict[str, Any]):
        ...
        1. query_type: نوع الاستعلام (جبري/هندسي/تفاضل_وتكامل/إحصاء/نظرية_الأعداد/تطبيقي/تحية)
        ...
        ملاحظة مهمة: إذا كان الاستعلام عبارة عن تحية (مثل "السلام عليكم"، "مرحبا"، "صباح الخير") أو سؤال عام عن قدرات النظام، حدد query_type كـ "تحية".
        
        الاستعلام: {query}
        
        أعد فقط JSON بالتنسيق التالي بدون أي نص إضافي:
        {{
          "query_type": "جبري/هندسي/تفاضل_وتكامل/إحصاء/نظرية_الأعداد/تطبيقي/تحية",
